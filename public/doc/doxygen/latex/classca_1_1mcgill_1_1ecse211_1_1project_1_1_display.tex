...
79       lcd.drawString(\textcolor{stringliteral}{"D: "} + numberFormat.format(sensdata.\hyperlink{classca_1_1mcgill_1_1ecse211_1_1threads_1_1_sensor_data_a46cc30522719018a80f89624e0ce458f}{getD}()), 0, 5);
80 
81 \textcolor{comment}{//      lcd.drawString(String.format("(R: %d G: %d B: %d)", (int) rgb[0], (int) rgb[1], (int) rgb[2]),}
82 \textcolor{comment}{//          0, 4);}
...
93 
94       \textcolor{comment}{// lcd.drawString(String.format("(r: %f", rgb[0]), 0, 3);}
95       \textcolor{comment}{// lcd.drawString(String.format("(g: %f", rgb[1]), 0, 4);}
96       \textcolor{comment}{// lcd.drawString(String.format("(b: %f", rgb[2]), 0, 5);}
97 
