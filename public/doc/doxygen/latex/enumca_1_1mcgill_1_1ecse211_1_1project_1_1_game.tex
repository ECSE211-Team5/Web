...
\begin{DoxyCode}
359                                                       \{
360     \textcolor{comment}{// Motor Objects, and Robot related parameters}
361     Port usPort = LocalEV3.get().getPort(\textcolor{stringliteral}{"S1"});
362     \textcolor{comment}{// initialize multiple light ports in main}
363     Port[] lgPorts = \textcolor{keyword}{new} Port[3];
364 
365     \textcolor{comment}{// Light sensor sensor stuff}
366     lgPorts[0] = LocalEV3.get().getPort(\textcolor{stringliteral}{"S2"});
367     lgPorts[1] = LocalEV3.get().getPort(\textcolor{stringliteral}{"S3"});
368     lgPorts[2] = LocalEV3.get().getPort(\textcolor{stringliteral}{"S4"});
369     EV3ColorSensor[] lgSensors = \textcolor{keyword}{new} EV3ColorSensor[3];
370     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < lgSensors.length; i++) \{
371       lgSensors[i] = \textcolor{keyword}{new} EV3ColorSensor(lgPorts[i]);
372     \}
373 
374     Odometer odometer = Odometer.getOdometer(\hyperlink{enumca_1_1mcgill_1_1ecse211_1_1project_1_1_game_a7c673571bf50fdb6917a9d7bb671e003}{leftMotor}, \hyperlink{enumca_1_1mcgill_1_1ecse211_1_1project_1_1_game_a7a05fcf37c4435c32270776a427ba0d2}{rightMotor}, 
...
375 
376     \textcolor{comment}{// Sensor Related Stuff}
377     SensorData sensorData = SensorData.getSensorData();
378 
379     \textcolor{comment}{// Ultrasonic sensor stuff}
380     @SuppressWarnings(\textcolor{stringliteral}{"resource"})
381     SensorModes usSensor = new EV3UltrasonicSensor(usPort);
382     SampleProvider usDistance = usSensor.getMode("Distance");
383     \textcolor{keywordtype}{float}[] usData = new \textcolor{keywordtype}{float}[usDistance.sampleSize()];
384 
385     SampleProvider backLight[] = new SampleProvider[2];
386     backLight[0] = lgSensors[0].getRedMode();
387     backLight[1] = lgSensors[1].getRedMode();
388     
389     \textcolor{comment}{//colour detection sensor}
390     SampleProvider frontLight[] = new SampleProvider[1];
391     frontLight[0] = lgSensors[2].getRGBMode();
392 
393 \textcolor{comment}{//    TextLCD lcd = LocalEV3.get().getTextLCD();}
394 \textcolor{comment}{//    Display odometryDisplay = new Display(lcd);}
395 \textcolor{comment}{//    // STEP 1: LOCALIZE to (1,1)}
396 \textcolor{comment}{//    // ButtonChoice left or right}
397 \textcolor{comment}{//    lcd.clear();}
398 \textcolor{comment}{//    lcd.drawString("<  Left  |  Right >", 0, 0);}
399 \textcolor{comment}{//    lcd.drawString(" falling | rising  ", 0, 1);}
400 \textcolor{comment}{//    lcd.drawString("  edge   |  edge   ", 0, 2);}
401 \textcolor{comment}{//    lcd.drawString("        \(\backslash\)\(\backslash\)/        ", 0, 3);}
402 \textcolor{comment}{//    lcd.drawString("  Color Detection  ", 0, 4);}
403 
404     \textcolor{comment}{// Start odometer and odometer display}
405     Thread odoThread = new Thread(odometer);
406     odoThread.start();
407 \textcolor{comment}{//    Thread odoDisplayThread = new Thread(odometryDisplay);}
408 \textcolor{comment}{//    odoDisplayThread.start();}
409     Sound.beep();
410     \textcolor{comment}{// Start ultrasonic and light sensors}
411     \hyperlink{enumca_1_1mcgill_1_1ecse211_1_1project_1_1_game_af6fee74efff891793b32352caa110465}{usPoller} = new UltrasonicPoller(usDistance, usData, sensorData);
412     Thread usThread = new Thread(\hyperlink{enumca_1_1mcgill_1_1ecse211_1_1project_1_1_game_af6fee74efff891793b32352caa110465}{usPoller});
413     usThread.start();
414     lightPoller = new LightPoller(backLight, new \textcolor{keywordtype}{float}[2][backLight[1].sampleSize()], sensorData);
415     Thread lightThread = new Thread(lightPoller);
416     lightThread.start();
417 
418     \hyperlink{enumca_1_1mcgill_1_1ecse211_1_1project_1_1_game_af24a953a0c3438670220dde36c532b5d}{rgbPoller} = new RGBPoller(frontLight, new \textcolor{keywordtype}{float}[1][frontLight[0].sampleSize()], sensorData);
419     Thread rgbThread = new Thread(\hyperlink{enumca_1_1mcgill_1_1ecse211_1_1project_1_1_game_af24a953a0c3438670220dde36c532b5d}{rgbPoller});
420     
421     rgbThread.start();
422     
423    
...
Definition at line 431 of file Game.\+java.


\begin{DoxyCode}
431                                                   \{
432     GameParameters.Demo = DemoType.Beta;
433     \textcolor{comment}{// Start localizing}
434     \textcolor{keyword}{final} Navigation navigation = \textcolor{keyword}{new} Navigation(\hyperlink{enumca_1_1mcgill_1_1ecse211_1_1project_1_1_game_a7c673571bf50fdb6917a9d7bb671e003}{leftMotor}, \hyperlink{enumca_1_1mcgill_1_1ecse211_1_1project_1_1_game_a7a05fcf37c4435c32270776a427ba0d2}{rightMotor});
435     \textcolor{keyword}{final} UltrasonicLocalizer usLoc = \textcolor{keyword}{new} UltrasonicLocalizer(navigation, 
...
436     \textcolor{keyword}{final} LightLocalizer lgLoc = \textcolor{keyword}{new} LightLocalizer(navigation, \hyperlink{enumca_1_1mcgill_1_1ecse211_1_1project_1_1_game_a7c673571bf50fdb6917a9d7bb671e003}{leftMotor}, 
      \hyperlink{enumca_1_1mcgill_1_1ecse211_1_1project_1_1_game_a7a05fcf37c4435c32270776a427ba0d2}{rightMotor});
437     \textcolor{keyword}{final} RingSearcher searcher = \textcolor{keyword}{new} RingSearcher(\hyperlink{enumca_1_1mcgill_1_1ecse211_1_1project_1_1_game_aa94b85dc88de85d959677bd6c0f98989}{sensorMotor}, 
      \hyperlink{enumca_1_1mcgill_1_1ecse211_1_1project_1_1_game_abc070af2fa5a5cda6d81977b35aacfb4}{rodMotor});
438     
439     Button.waitForAnyPress(); \textcolor{comment}{// Wait for button press to start}
